...
public class ChineseASCII extends JPanel implements ActionListener {
	...
	public ChineseASCII () {
	    ...
	    outputArea.setFont(new Font("Lucida Sans Typewriter", Font.PLAIN, 12));
		...
		Charset cs = Charset.forName("x-EUC-CN");
	...
	public void actionPerformed(ActionEvent e) {
		...
		//	byte[] baold = stuff.getBytes();
			...
			else if (si==4) numPerLine = 5;
			else if (si==5) numPerLine = 6;
	...
	*/
    ...
    public static final void main(String[] args) {
		//ChineseASCII ca = new ChineseASCII();
...
class MyFrame extends JFrame {
	public MyFrame() {
		...
		setTitle("Chinese2ascii Converter");
      // Create a menu and finish the GUI.

		Container contentPane = getContentPane();
		ChineseASCII output = new ChineseASCII ();
