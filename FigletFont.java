...
class FigletFont {
  ...
  public FigletFont(URL aURL, int num) {
    font = new char[num][][];
    InputStream conn;
    BufferedReader data;
    String dummyS;
  ...
  public static final void main(String[] args) {
	  try{
	  FigletFont ff = new FigletFont(new URL("file:/c:/0synch/h2s/figlet-src/gb16fs.flf"),5000);
	  System.out.println("loaded ifle apparently");
	  System.out.println(ff.getCharLineString(1,1));
	  System.out.println(ff.getCharLineString(2,1));
	  System.out.println(ff.getCharLineString(3,1));
	  System.out.println(ff.getCharLineString(4,1));
  	}
